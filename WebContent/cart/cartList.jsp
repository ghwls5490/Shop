	...
	<center>
		...
		<c:forEach items="${List}" var="List" varStatus="status">
			<table border="1">
				...
				<tr>
					<td><a href="itemDetail.item?num=${List.itemNum} ">${List.itemNum}</a></td>
					<td><a href="itemDetail.item?num=${List.itemNum}">${List.itemName}</a></td>
					<td><a href="itemDetail.item?num=${List.itemNum}">${List.itemPrice}</a></td>
					<td><a href="itemDetail.item?num=${List.itemNum}">${List.itemContent}</a></td>
					<td><a href="itemDetail.item?num=${List.itemNum}"><img src="uploadFolder/${List.itemImage}"
				style="width: 100px; height: 100px;"></a></td>
					<td><a href="cartDelete.cart?num=${List.itemNum}">장바구니 삭제</a></td>
				</tr>
			</table>
		</c:forEach>
	</center>
