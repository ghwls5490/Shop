...
<header id="home">
	...
	<Center>
  <form action="boardDetailForm.bo" method="post"  enctype="multipart/form-data">  
  	<h1>게시글 상세보기</h1>
		<table>
		
		<tr>
			<th>번호 : </th>
			<td><p>${boardInfo.boardNum}</p></td>	
		</tr>
		...
		<tr>
			<th>제목:</th>
			<td><p>${boardInfo.boardTitle}</p></td>	
		</tr>
		
		<tr>
			<td><p><img src="uploadFolder/${boardInfo.boardImage}" style="width: 300px; height: 300px;"></p></td>
		</tr>
		 
		<tr>
			<th>내용:</th>
			<td><p>${boardInfo.boardContent}</p></td>	
		</tr>
		
		
		<tr>
			<th>첨부파일:</th>
			<td><p>${boardInfo.boardImage}</p></td>	
		</tr>
		
		<tr>
			<td><a href="boardDelete.bo?num=${boardInfo.boardNum}">상품삭제</a></td>
		    <td><a href="boardUpdateForm.bo?num=${boardInfo.boardNum} ">상품수정</a></td>
		</tr>
	</table>
