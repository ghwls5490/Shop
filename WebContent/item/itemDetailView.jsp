...
<header id="home">
	...
	<h1>상품 상세보기</h1>
		<table border="1">
			<td>
				<img src="uploadFolder/${itemInfo.itemImage}"
			...
			<td>
				<table border="1" style="height: 300px; width: 400px;">
					<tr>
						...
						<td align="center">${itemInfo.itemNum}</td>
					</tr>
					
					<tr>
						<td align="center">상품명</td>
						<td align="center">${itemInfo.itemName}</td>
					</tr>
					
					<tr>
						<td align="center">상품가격</td>
						<td align="center">${itemInfo.itemPrice}</td>
					</tr>
					
					<tr>
						<td align="center">상품내용</td>
						<td align="center">${itemInfo.itemContent}</td>
					</tr>
