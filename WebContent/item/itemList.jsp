...
<header id="home">
	...
	<h1 style="font-family: 'Do Hyeon', sans-serif;">상품리스트</h1>
	</br>
	<c:forEach items="${itemList}" var="itemList" varStatus="status">	
		<table border="1">
			<tr>
			 ...
			 <tr>
				<td><a href="itemDetail.item?num=${itemList.itemNum} ">${itemList.itemNum}</a></td>
				<td><a href="itemDetail.item?num=${itemList.itemNum}">${itemList.itemName}</a></td>
				<td><a href="itemDetail.item?num=${itemList.itemNum}">${itemList.itemPrice}</a></td>
				<td><a href="itemDetail.item?num=${itemList.itemNum}">${itemList.itemContent}</a></td>
				<td><a href="itemDetail.item?num=${itemList.itemNum}"><img src="uploadFolder/${itemList.itemImage}"
				style="width: 164px; height: 100px;"></a></td>
				<%-- <td><a href="itemDelete.item?num=${itemList.itemNum}">상품삭제</a></td>
			    <td><a href="itemModifyDetail.item?num=${itemList.itemNum}">상품수정</a></td> --%>
			    <td><a href="cartRegist.cart?num=${itemList.itemNum}&id=${id}">장바구니 담기</a></td>
			 </tr>	
